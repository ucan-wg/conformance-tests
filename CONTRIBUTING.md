# Contributing to ucan-fixture-generator
...
The main way to get help is by sending an email to [support@fission.codes][support-email].
...
need to be the best programmer to contribute.
 ...
 6. **Build** the project
    - For a detailed look on how to build ucan-fixture-generator look at our
