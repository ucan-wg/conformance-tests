...
impl Identities<Ed25519KeyMaterial> {
    pub async fn new() -> Self {
        let alice_key = ed25519_key_from_base64("U+bzp2GaFQHso587iSFWPSeCzbSfn/CbNHEz7ilKRZ1UQMmMS7qq4UhTzKn3X9Nj/4xgrwa+UqhMOeo4Ki8JUw==").unwrap();
        ...
        let mallory_key  = ed25519_key_from_base64("G4+QCX1b3a45IzQsQd4gFMMe0UB1UOx9bCsh8uOiKLER69eAvVXvc8P2yc4Iig42Bv7JD2zJxhyFALyTKBHipg==").unwrap();
